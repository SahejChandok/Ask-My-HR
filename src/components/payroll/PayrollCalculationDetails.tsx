...
export function PayrollCalculationDetails({ logs }: PayrollCalculationDetailsProps) {
  // Group logs by type
      ...
      render: (log: PayrollCalculationLog) => (
        <div className="space-y-2">
          ...
          <div className="flex justify-between">
            ...
            <span>{log.details.regular_hours?.toFixed(2) || '0.00'}h</span>
          </div>
          <div className="flex justify-between">
            <span>Overtime Hours</span>
            <span>{log.details.overtime_hours?.toFixed(2) || '0.00'}h</span>
          </div>
          <div className="flex justify-between">
            <span>Holiday Hours</span>
            <span>{log.details.holiday_hours?.toFixed(2) || '0.00'}h</span>
          </div>
        </div>
      )
    },
