...
DROP FUNCTION IF EXISTS trigger_update_admin_metrics() CASCADE;
DROP FUNCTION IF EXISTS update_admin_metrics(uuid) CASCADE;
...
-- Create trigger function to update metrics on changes
