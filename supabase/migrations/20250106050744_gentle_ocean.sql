...
-- Create table for rollback audit logs
...
CREATE POLICY "tenant_access_policy" ON payroll_rollback_logs
  FOR SELECT
  TO authenticated
  USING (
    payroll_run_id IN (
...
-- Create function to rollback payroll run
