...
GRANT EXECUTE ON FUNCTION calculate_paye_tax(numeric, text) TO authenticated;
GRANT EXECUTE ON FUNCTION calculate_acc_levy(numeric, numeric) TO authenticated;
GRANT EXECUTE ON FUNCTION calculate_deductions(numeric, text, numeric, boolean) TO authenticated;
