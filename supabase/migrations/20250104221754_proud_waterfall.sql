...
GRANT EXECUTE ON FUNCTION bulk_load_timesheets(uuid, date, date) TO authenticated;
GRANT EXECUTE ON FUNCTION bulk_load_employees(uuid, uuid[]) TO authenticated;
GRANT EXECUTE ON FUNCTION bulk_create_payslips(uuid, jsonb[]) TO authenticated;