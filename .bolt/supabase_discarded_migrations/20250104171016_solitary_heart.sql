...
BEGIN
  ...
  SELECT 
    ...
    '09:00'::time,
    CASE 
      WHEN n IN (1, 3) THEN '18:00'::time  -- Overtime days
      ELSE '17:00'::time
    END,
    30,
    CASE 
      WHEN n IN (1, 3) THEN 'Overtime day'
      ELSE 'Regular day'
    END,
    n IN (1, 3)  -- Mark overtime days
  FROM generate_series(0, 4) n;

  -- Bob's entries (regular salary)
  INSERT INTO timesheet_entries (
